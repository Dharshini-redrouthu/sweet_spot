...
import { cakeData as cakesA } from '../../data/cake_data';
import { cakeData as cakesB } from '../../data/cake_data_2';

const CakeList = ({ onEdit, onDelete }) => {
  const combinedCakes = [...cakesA, ...cakesB];

  return (
    <div className="p-6 max-w-7xl mx-auto font-parastoo">
      <h2 className="text-5xl text-[rgba(79,79,79,0.66)] mb-8">
        Manage Cake Collection
      </h2>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {combinedCakes.map((cake) => (
          <div
            key={cake.id}
          ...
          >
            ...
            <div className="p-5">
              <h3 className="text-2xl font-semibold text-[rgba(79,79,79,0.7)] mb-1">
                {cake.name}
              </h3>
